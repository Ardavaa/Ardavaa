...
ROWS = [
    ("host",),
    ("kv", "Now", "Student @ Telkom University"),
    ("kv", "Prev", "AI/ML Researcher"),
    ("kv", "Also", "Front-End Developer"),
    ("kv", "Edu", "B.S. Data Science, Telkom Univ '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "ML/AI", "Python, TensorFlow, PyTorch"),
    ("kv", "Data", "Pandas, NumPy, Matplotlib, MLflow"),
    ("kv", "Cloud", "Azure, Vercel, Netlify"),
    ("kv", "DevOps", "Git, Node.js"),
    ("kv", "LLMs", "Generative AI, LLMs"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "PRODIGI Community Leader"),
    ("bul", "Solo Founder & Developer"),
    ("bul", "Data Science Projects"),
]
