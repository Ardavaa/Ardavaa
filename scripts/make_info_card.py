...
ROWS = [
    ...
    ("kv", "Prev", "Chairperson @ PRODIGI"),
    ("kv", "Also", "ML/AI Enthusiast"),
    ("kv", "Edu", "Informatics, Telkom Univ '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI/ML", "Python, TensorFlow, PyTorch"),
    ("kv", "Data", "Data Science, EDA"),
    ("kv", "Tools", "Git, Jupyter, Colab, HuggingFace"),
    ("kv", "Focus", "Computer Vision, NLP"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "PRODIGI Community Leader"),
    ("bul", "Competitive Programming & Innovation"),
